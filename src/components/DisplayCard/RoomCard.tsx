    ...
    return (
        <div className="max-w-xs bg-white rounded-xl shadow-md overflow-hidden transform hover:scale-[1.02] hover:shadow-lg transition duration-300">
            ...
            <div className="p-4 space-y-2">
                ...
                <div className="text-sm text-gray-500">Room Dimension -</div>
                ...
                <button className="mt-3 w-full bg-buttons text-white py-2 rounded-md hover:bg-buttonsHover transition">
                    View Phone No.
                </button>
