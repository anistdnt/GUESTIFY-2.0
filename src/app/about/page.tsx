  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100">
        {/* Hero Section */}
        <section className="bg-aboutBackground text-white py-20 text-center">
          <div className="mx-auto text-aboutContent">
            <h1 className="text-4xl font-bold">About Guestify</h1>
        ...
        {/* Mission Section */}
        <section className="mx-auto py-16 px-6 container">
